...
public abstract class BinaryParser implements BlockReaderAdapter {
   ...
   * 
   * Index 0 is reserved to use as a delimiter, therefore, index 1 corresponds to the first string
   * in the table
   * 
   * @param id
   * @return
  ...
  /**
   * Convert a latitude value stored in a protobuf into a double, compensating for granularity and
   * latitude offset
   */
  ...
  /**
   * Convert a longitude value stored in a protobuf into a double, compensating for granularity and
   * longitude offset
   */
