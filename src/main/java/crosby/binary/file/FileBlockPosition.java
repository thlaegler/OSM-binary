...
/**
 * Stores the position in the stream of a fileblock so that it can be easily read in a random-access
 * fashion.
 * 
...
public class FileBlockPosition extends FileBlockBase {
  ...
  /*
   * Given any form of fileblock and an offset/length value, return a reference that can be used to
   * dereference and read the contents.
   */
