 ...
 * 
 * Subclasses of this include additional fields, such as byte offsets that let a fileblock be read
 * in a random-access fashion, or the data itself.
 * 
 * @author crosby
 * 
 */
public class FileBlockBase {
  ...
  /**
   * If a block header is bigger than this, fail. We use excessively large header size as an
   * indication of corrupt files
   */
  static final int MAX_HEADER_SIZE = 64 * 1024;
  /**
   * If a block's size is bigger than this, fail. We use excessively large block sizes as an
   * indication of corrupt files
   */
