...
public class FileBlockReference extends FileBlockPosition {
  ...
  /**
   * Convenience cache for storing the input this reference is contained within so that it can be
   * cached
   */
  ...
  static FileBlockPosition newInstance(FileBlockBase base, InputStream input, long offset,
      int length) {
