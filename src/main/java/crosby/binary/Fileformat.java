...
public final class Fileformat {
  ...
  public static final class Blob
      extends com.google.protobuf.GeneratedMessageLite<Blob, Blob.Builder> implements
    ...
    public static crosby.binary.Fileformat.Blob parseFrom(java.nio.ByteBuffer data)
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<crosby.binary.Fileformat.Blob, Builder>
        implements
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          ...
          zlibData_ = visitor.visitByteString(hasZlibData(), zlibData_, other.hasZlibData(),
              other.zlibData_);
          lzmaData_ = visitor.visitByteString(hasLzmaData(), lzmaData_, other.hasLzmaData(),
              other.lzmaData_);
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<crosby.binary.Fileformat.Blob> parser = PARSER;
          if (parser == null) {
            synchronized (crosby.binary.Fileformat.Blob.class) {
              parser = PARSER;
              if (parser == null) {
  ...
  public static final class BlobHeader
    ...
    public static crosby.binary.Fileformat.BlobHeader parseFrom(java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
    }
     ...
     */
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<crosby.binary.Fileformat.BlobHeader, Builder>
        implements
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          ...
          indexdata_ = visitor.visitByteString(hasIndexdata(), indexdata_, other.hasIndexdata(),
              other.indexdata_);
          datasize_ =
              visitor.visitInt(hasDatasize(), datasize_, other.hasDatasize(), other.datasize_);
          if (visitor == com.google.protobuf.GeneratedMessageLite.MergeFromVisitor.INSTANCE) {
            bitField0_ |= other.bitField0_;
          }
          return this;
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<crosby.binary.Fileformat.BlobHeader> parser = PARSER;
          if (parser == null) {
            synchronized (crosby.binary.Fileformat.BlobHeader.class) {
              parser = PARSER;
              if (parser == null) {
                parser = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                PARSER = parser;
